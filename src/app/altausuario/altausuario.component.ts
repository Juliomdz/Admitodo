...
export class AltausuarioComponent implements OnInit {
  ...
  escanearDNI()
  {
    ...
    {
      this.contenido = a.rawValue.split('@');;
  ...
  async subirUsuario()
  {
    ...
    if (this.clave == this.claveConfirm && this.nombre != "" && this.apellido != "" && this.mail != "" && this.clave != "" && this.dni != undefined)
    {
      ...
      {
        await this.srvFirebase.subirUsuarioDB(this.nombre, this.apellido, this.mail, this.dni, this.clave, this.fotoFile);
        this.nombre = "";
        this.apellido = "";
        this.mail = "";
        this.dni = undefined;
        ...
        //LogedComponent.prototype.usuariosLeidos = await this.srvFirebase.leerDBUsuarios();
        this.routerRecieved.navigate(['/loged']);
      }
      else
      {
